...
const SettingsRow = ({
  ...
  if (!onPress) {
    return <View style={[styles.row, isFirst && styles.rowFirst]}>{content}</View>;
  }
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{strings.settings.authTitle}</Text>
          <Text style={styles.sectionDescription}>
            {strings.settings.authDescription}
          </Text>
          <SettingsRow
            label={strings.settings.currentUserLabel}
            value={currentUserId}
            icon="👤"
            isFirst
          />
          <SettingsRow
            label={strings.settings.logoutAction}
            onPress={handleLogout}
            disabled={isSigningOut}
            value={isSigningOut ? strings.settings.loggingOutValue : undefined}
            icon="🚪"
          />
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {strings.settings.devToolsTitle}
          </Text>
          <Text style={styles.sectionDescription}>
